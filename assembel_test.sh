...
model_path='saved_models/ResNet50_CIFAR10_seed7.pth'
...
mask_dir='saved_masks/masks_ResNet50_CIFAR10_seed7/'
dis_dir='saved_dis_models'
dis_name='ResNet50_CIFAR10_seed7_disassembled_3_9.pth'
subset_dir='saved_sub_datasets/cifar10_images_seed7/test_3_9'

disa_layers='-1'
disa_labels='3 4 5 6 7 8 9'


python3 Model-LEGO-main/core/sample_select \
